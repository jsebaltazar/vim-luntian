...
hi Normal guifg=#0acf00 guibg=#1c2f2c guisp=#1c2f2c gui=NONE ctermfg=40 ctermbg=236 cterm=NONE
...
hi Statement guifg=#ff5100 guibg=NONE guisp=NONE gui=bold ctermfg=202 ctermbg=NONE cterm=bold
...
hi Function guifg=#ffd900 guibg=NONE guisp=NONE gui=bold,italic ctermfg=220 ctermbg=NONE cterm=bold
hi FoldColumn guifg=#8b8bcd guibg=#2e2e2e guisp=#2e2e2e gui=NONE ctermfg=104 ctermbg=236 cterm=NONE
hi PreProc guifg=#4affff guibg=NONE guisp=NONE gui=NONE ctermfg=87 ctermbg=NONE cterm=NONE
...
hi String guifg=#0c9462 guibg=#1c2f2c guisp=#1c2f2c gui=NONE ctermfg=29 ctermbg=236 cterm=NONE
